...
alias cd="cdls"
alias cm="cd ${CATKIN_HOME} && catkin_make -DROS_EDITION=ROS1 && cd -"
...
alias rosbag_record_recommender='python3 /catkin_ws/src/vibe_modules/scripts/rosbag_record_recommender.py'
